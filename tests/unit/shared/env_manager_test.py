...
class TestEnvManager:
    @pytest.mark.unit
    def test_get_runtime_environment_development(self, mocker: MockerFixture):
    ...
    @pytest.mark.unit
    def test_get_runtime_environment_development_uppercase(self, mocker: MockerFixture):
        mocker.patch.dict(os.environ, {"ENVIRONMENT": "DEVELOPMENT"})
        result = EnvManager.get_runtime_environment()
        assert result == EnvManager.RuntimeEnvironment.DEVELOPMENT

    @pytest.mark.unit
    def test_get_runtime_environment_production(self, mocker: MockerFixture):
    ...
    @pytest.mark.unit
    def test_get_runtime_environment_empty_string_defaults_to_production(self, mocker: MockerFixture):
        mocker.patch.dict(os.environ, {"ENVIRONMENT": ""})
        result = EnvManager.get_runtime_environment()
        assert result == EnvManager.RuntimeEnvironment.PRODUCTION

    @pytest.mark.unit
    def test_get_database_url_success(self, mocker: MockerFixture):
        mocker.patch.dict(os.environ, {"DATABASE_URL": "postgres://user:pass@localhost/db"})
        result = EnvManager.get_database_url()
        assert result == "postgres://user:pass@localhost/db"

    @pytest.mark.unit
    def test_get_database_url_not_set_raises_error(self, mocker: MockerFixture):
        mocker.patch.dict(os.environ, {}, clear=True)
    ...
    @pytest.mark.unit
    def test_get_database_url_empty_string_raises_error(self, mocker: MockerFixture):
    ...
    @pytest.mark.unit
    def test_get_method_returns_none_when_not_set(self, mocker: MockerFixture):
